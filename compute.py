    ...
    if is_single:
        ...
        for i in range(len(first_ring)):
            ...
            for f_potential in friend_in_first_ring:
                ...
                if place == -1:
                    ...
                    exit(-1)
                final_score += funclib.resolve_pattern_jump(piece_patterns)
                ...
                for e_potential in enemy_in_first_ring:
                    ...
                    if place == -1:
                        ...
                        exit(-1)
                    final_score += funclib.resolve_pattern_jump_rev(piece_patterns)
    else:
        ...
        for i in range(-4, 5):
            ...
            if 0 <= y + i <= 14 and 0 <= x - i <= 14:
                ...
                lt_rb.append(-1)
        final_score+=funclib.resolve_pattern_cont(lt_rb)
        final_score+=funclib.resolve_pattern_cont(u_d)
